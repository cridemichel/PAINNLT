...
public:
    PaiNN_ML_Potential(const std::string& model_path, int num_atoms, int hidden_channels, int n_layers, int num_rbf, double cutoff, const std::string& device_str = "auto");
