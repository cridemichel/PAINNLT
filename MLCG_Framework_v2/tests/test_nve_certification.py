...
class NVECertificationTests(unittest.TestCase):
    ...
    def test_nve_precision_switch_is_propagated(self):
        ...
        self.assertIn('--ml-precision', certify_source)
        self.assertIn('"--ml_precision", args.ml_precision', certify_source)
    ...
    def test_neighbor_search_switch_is_propagated(self):
        ...
        self.assertIn('n_square_types=morse_n_square_types', runner_source)
        self.assertIn('--neighbor_search', equilibrate_source)
        self.assertIn('configure_neighbor_search(', equilibrate_source)
        self.assertIn('n_square_types=morse_n_square_types', equilibrate_source)
