...
def validate_run(run_dir: Path, expected_epochs: int) -> dict:
    names = {
    ...
    return {
        "schema_version": 1,
        "kind": "tel22_antiparallel_local_pipeline_smoke",
        "status": "PASS",
...
def main() -> None:
    ...
    report = validate_run(args.run_dir, args.expected_epochs)
