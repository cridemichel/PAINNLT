...
: "${NVE_DT_TAG:=0p005}"
: "${NVE_ENERGY_CSV:=diagnostics/nve/nve_certification/dt_${NVE_DT_TAG}/energy.csv}"
: "${SHORT_RANGE_THRESHOLD_NM:=0.20}"
: "${SHORT_RANGE_REPORT:=diagnostics/nve/nve_certification/short_range_diagnostic_${NVE_DT_TAG}.json}"
