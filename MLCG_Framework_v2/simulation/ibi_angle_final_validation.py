...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--step32-candidate-name", default="smooth_0p0075")
    p.add_argument("--expected-sigma-rad", type=float, default=0.0075)
    p.add_argument("--dts", type=float, nargs="+", default=[0.001, 0.002, 0.003, 0.004, 0.005])
    p.add_argument("--nve-duration-ps", type=float, default=1.0)
    p.add_argument("--short-branch-dt", type=float, default=0.0005)
    p.add_argument("--short-branch-duration-ps", type=float, default=0.25)
    p.add_argument("--new-replica-seeds", type=int, nargs="+", default=[330001, 330002])
    p.add_argument("--long-branch-dt", type=float, default=0.0005)
    p.add_argument("--long-branch-duration-ps", type=float, default=2.0)
    p.add_argument("--long-thermostat-seed", type=int, default=330100)
    p.add_argument("--kT", type=float, default=2.49)
    p.add_argument("--device", default="cpu")
    p.add_argument("--ml-precision", default="float32")
    p.add_argument("--neighbor-search", choices=("verlet", "link-cell"), default="link-cell")
    p.add_argument("--output-dir", type=Path, required=True)
    p.add_argument("--common-p-min", type=float, default=1.8)
    p.add_argument("--common-p-max", type=float, default=2.2)
    p.add_argument("--common-r2-min", type=float, default=0.95)
    p.add_argument("--full-clean-dt", type=float, default=0.005)
    p.add_argument("--min-clean-dt", type=float, default=0.003)
    p.add_argument("--min-full-clean-replicas", type=int, default=2)
    p.add_argument("--median-c2-spread-max", type=float, default=2.0)
    p.add_argument("--max-relative-block-drift", type=float, default=2e-5)
    p.add_argument("--weighted-angle-delta-max", type=float, default=0.03)
    p.add_argument("--weighted-bond-delta-max", type=float, default=0.03)
    p.add_argument("--max-group-angle-delta-max", type=float, default=0.10)
    p.add_argument("--kinetic-relative-delta-max", type=float, default=0.03)
    p.add_argument("--curvature-reduction-min", type=float, default=1.2)
