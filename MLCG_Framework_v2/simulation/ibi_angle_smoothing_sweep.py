...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--new-sigmas", type=float, nargs="+", default=[0.0075, 0.0125, 0.015])
    p.add_argument("--reuse-sigma", type=float, default=0.01)
    p.add_argument("--reuse-variant", default="smooth_0p01")
    ...
    p.add_argument("--thermostat-seed", type=int, default=310000)
