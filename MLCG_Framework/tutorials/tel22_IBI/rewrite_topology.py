...
for b in data.get("bonds", []):
    if isinstance(b, list):
        # Implicit backbone bond: [mol_i, mol_j, site_i, site_j]
...
with open("tel22_topology_new.json", "w") as f:
    json.dump(data, f, indent=4)

print("Riscrittura completata con successo! Generato tel22_topology_new.json")
