...
#include "SchNet_Architecture.hpp"
...
struct CGSite {
    int molecule_id; 
    int site_type;   // Usato come "atomic_number" per l'embedding di SchNet
    float x, y, z;
};
...
struct EarlyStopping {
    ...
    void check(SchNetModel& model, float val_loss) { 
...
int main(int argc, char* argv[]) {
    ...
    SchNetModel model(num_species, dim, layers, num_rbf, cutoff);
    model->to(device);
